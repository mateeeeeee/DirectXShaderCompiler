...
// CHECK-NEXT: ImplicitCastExpr 0x{{[0-9a-fA-F]+}} <col:29> 'const .ResourceDescriptorHeap' lvalue <NoOp>
// CHECK-NEXT: DeclRefExpr 0x{{[0-9a-fA-F]+}} <col:29> '.ResourceDescriptorHeap' lvalue Var 0x{{[0-9a-fA-F]+}} 'ResourceDescriptorHeap' '.ResourceDescriptorHeap'
