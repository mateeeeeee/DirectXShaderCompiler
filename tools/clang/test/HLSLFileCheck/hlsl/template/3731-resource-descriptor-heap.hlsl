...
// CHECK-NEXT: ImplicitCastExpr 0x{{[0-9a-fA-F]+}} <col:29> 'const .ResourceHeap' lvalue <NoOp>
// CHECK-NEXT: DeclRefExpr 0x{{[0-9a-fA-F]+}} <col:29> '.ResourceHeap' lvalue Var 0x{{[0-9a-fA-F]+}} 'ResourceDescriptorHeap' '.ResourceHeap'
